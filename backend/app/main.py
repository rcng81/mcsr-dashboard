...
with engine.begin() as conn:
    ...
    conn.execute(text("ALTER TABLE players ADD COLUMN IF NOT EXISTS twitch_url VARCHAR"))
    conn.execute(text("ALTER TABLE players ADD COLUMN IF NOT EXISTS youtube_url VARCHAR"))
    conn.execute(text("ALTER TABLE players ADD COLUMN IF NOT EXISTS discord_id VARCHAR"))
    conn.execute(text("ALTER TABLE players ADD COLUMN IF NOT EXISTS discord_username VARCHAR"))
